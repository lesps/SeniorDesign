...
\subtitle{Dept. of CIS - Senior Design 2013-2014\thanks{Advisor: Insup Lee (lee@cis.upenn.edu).}~\thanks{ Do not list your advisors amongst the authors as that may cause Google Scholar to add this work to their list of publications. Your advisor must also sign a hard-copy of your proposal.}}
\numberofauthors{2}
\author{
\alignauthor Junkil Park \\ \email{junkil.park@cis.upenn.edu} \\ Univ. of Pennsylvania \\ Philadelphia, PA
...
field. More importantly, note their shortcomings -- these you will
exploit to come up with a \textit{better} system.
...
citations easy. Your TA has had no difficulty, as the work of Wang
\textit{et al.}~\cite{wang13} demonstrates. Need help with \LaTeX{}?
...
effort and 2) you will convince the instructors that this is a project
worth undertaking.
...
Fig.~\ref{fig:some_graph} for the output! Remember to refer to your
figures in the body of your text; otherwise, the reader will keep
reading and will miss them!
