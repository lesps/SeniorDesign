...
%TODO: check for tense issues
%TODO: Make sure no citations on new lines
...
violations. For any detectors that require some sort of threshold, 
...
containing one or more .java files to the EC2 instance through a simple web app
created using PHP. The preferences 
...
Java. Multithreading and concurrency of the detectors is accomplished using the Java thread pool
library. The detection algorithms use the Eclipse Java Abstract Syntax Tree (AST) API to parse the
